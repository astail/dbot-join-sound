...
ボイスチャンネル（VC）の入室音 Bot。誰かが VC に入ると、その人が登録した音声（冒頭8秒まで）を再生します。入室音を登録していない人は、VOICEVOX の音声合成で「〇〇さんが入室しました」と読み上げます。退室したときは全員共通で「〇〇さんが退室しました」と読み上げます。
...
- **退室の読み上げ**: 誰かが VC から抜けると「〇〇さんが退室しました」と読み上げ。全員共通で、退室音は登録できない
